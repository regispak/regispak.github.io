      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex flex-col items-center px-4">
          ...
          <section className="w-full flex flex-col items-center justify-center text-center py-20">
            ...
            <motion.div
              className="w-full max-w-6xl px-4 text-left"
            ...
            >
              <button
                ...
                className="flex items-center text-white font-raleway font-bold hover:text-primary transition-colors"
              >
            ...
            {/* Hero Title */}
            <motion.h1
              className="text-5xl md:text-7xl lg:text-8xl font-lato font-bold text-[#8FBCBB] mb-6"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
            >
            ...
            {/* Description */}
            <motion.div
              className="max-w-3xl mx-auto font-raleway text-white/90 text-lg mb-12"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
